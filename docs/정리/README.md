...
- [프로그래밍 🔥](about:blank#%ED%94%84%EB%A1%9C%EA%B7%B8%EB%9E%98%EB%B0%8D)
  - 프로그래밍이란 뭐라고 생각하나요?
  - 컴파일러는 뭐고 인터프리터는 뭔가요? 🔥
- [자바스크립트란 🔥](about:blank#%EC%9E%90%EB%B0%94%EC%8A%A4%ED%81%AC%EB%A6%BD%ED%8A%B8%EB%9E%80)
  - 자바스크립트의 특징은 뭐가 있나요?
- [변수 🔥](about:blank#%EB%B3%80%EC%88%98)
  - 변수란 무엇인가요?
  - 식별자란 무엇인가요? 🔥
  ...
  - 네이밍 컨벤션은 어떤 것들이 있나요?
  - 리터럴이 뭔가요?
- [데이터 타입 🔥](about:blank#%EB%8D%B0%EC%9D%B4%ED%84%B0-%ED%83%80%EC%9E%85)
  - 데이터 타입의 종류는 어떤 것들이 있나요? 🔥
  - 심벌 타입은 뭐죠?
  - 데이터 타입은 왜 필요할까요? 🔥
  - 정적 타이핑이 뭔가요?
  - 동적 타이핑이 뭔가요?
- [타입변환과 단축 평가 🔥](about:blank#%ED%83%80%EC%9E%85%EB%B3%80%ED%99%98%EA%B3%BC-%EB%8B%A8%EC%B6%95-%ED%8F%89%EA%B0%80)
  - 명시적 타입 변환이 뭔가요?
  - 명시적 타입 변환 함수를 예를 들어볼 수 있나요?
  - 암묵적 타입 변환이 뭔가요?
  - truthy / falsy 한 값이 뭔가요?
- [배열 🔥](about:blank#%EB%B0%B0%EC%97%B4)
  - 자바스크립트의 배열은 자료구조의 배열과 같나요?
  - 배열의 메서드는 어떤 종류가 있나요?
  - 고차 함수에 대해서 아나요?
  - forEach 메서드와 map메서드의 차이점에 대해 알고 있나요?
- [객체 리터럴 🔥](about:blank#%EA%B0%9D%EC%B2%B4-%EB%A6%AC%ED%84%B0%EB%9F%B4)
  - 자바스크립트에서 객체란 뭘까요?
  - 함수와 메서드의 차이점에 대해 알고 계신가요?
  - 자바스크립트에서 객체를 생성하는 방법은 어떤 것들이 있나요?
- [원시 값과 객체 비교 🔥](about:blank#%EC%9B%90%EC%8B%9C-%EA%B0%92%EA%B3%BC-%EA%B0%9D%EC%B2%B4-%EB%B9%84%EA%B5%90)
  - 동적 타이핑을 지원하는 자바스크립트에서 데이터의 타입을 크게 2개로 나누는 이유가 있을까요? 🔥
  - 값에 의한 전달이 뭔가요? 🔥
  - 참조에 의한 전달이 뭔가요? 🔥
- [함수 🔥](about:blank#%ED%95%A8%EC%88%98)
  - 자바스크립트에서 함수를 정의하는 방법은 몇가지가 있나요?
  - 함수 선언문과 함수 표현식은 어떤 차이가 있나요?
  - 즉시 실행 함수(IIFE)에 대해 알고 있나요? 알고 있다면 아는 내용에 대해 말해보세요
- [스코프 🔥](about:blank#%EC%8A%A4%EC%BD%94%ED%94%84)
  - 스코프가 뭔가요? 🔥🔥
  - 스코프에는 어떤 종류가 있죠? 🔥
  - 렉시컬 스코프를 아나요? 안다면 렉시컬 스코프는 무엇을 의미하나요? 🔥
  - 전역 변수로 변수를 선언하면 생기는 문제점은 무엇이 있을까요?
- [생성자 함수에 의한 객체 생성 🔥](about:blank#%EC%83%9D%EC%84%B1%EC%9E%90-%ED%95%A8%EC%88%98%EC%97%90-%EC%9D%98%ED%95%9C-%EA%B0%9D%EC%B2%B4-%EC%83%9D%EC%84%B1)
  - 생성자 함수가 뭔가요?
  - 객체 리터럴로 만들 때와는 무슨 차이가 있죠? 왜 생성자 함수를 사용하나요?
  - 생성자 함수가 객체(인스턴스)를 생성하는 과정에 대해 간략하게 설명해줄 수 있나요?
- [함수와 일급 객체 🔥](about:blank#%ED%95%A8%EC%88%98%EC%99%80-%EC%9D%BC%EA%B8%89-%EA%B0%9D%EC%B2%B4)
  - 일급 객체가 뭔가요?
  - 자바스크립트에서 함수가 일급 객체라면, 일급 객체로 뭘 할 수 있나요?
  - 꼬리 질문) 함수형 프로그래밍이 뭔가요? 🔥
  - 꼬리 질문) 순수 함수가 뭔가요? 일반 함수와는 어떤 차이가 있죠? 🔥
- [프로토타입 🔥](about:blank#%ED%94%84%EB%A1%9C%ED%86%A0%ED%83%80%EC%9E%85)
  - 객체지향 프로그래밍은 무엇을 의미하나요? 🔥
  - 객체지향 프로그래밍의 특징에 대해 말해볼 수 있나요? 🔥
  - 자바스크립트는 객체지향 프로그래밍 언어인가요?
  - 프로토타입이 뭔가요?
- [strict mode 🔥](about:blank#strict-mode)
  - strict mode가 뭔가요?
  - strict mode를 통해 무엇을 예방할 수 있죠?
- [빌트인 객체 🔥](about:blank#%EB%B9%8C%ED%8A%B8%EC%9D%B8-%EA%B0%9D%EC%B2%B4)
  - 빌트인 객체가 뭔가요?
  - 빌트인 객체의 종류는 어떤게 있죠?
  - 래퍼 객체에 대해서 알고 있나요?
- [this 🔥](about:blank#this)
  - this가 뭔가요? 🔥
  - this 바인딩이란? 🔥
  - this는 동적으로 바인딩이 된다고 하는데 바인딩되는 객체가 어떻게 다르나요?
- [실행 컨텍스트 🔥](about:blank#%EC%8B%A4%ED%96%89-%EC%BB%A8%ED%85%8D%EC%8A%A4%ED%8A%B8)
  - 실행 컨텍스트에 대해 말해보세요 🔥🔥
- [클로저 🔥](about:blank#%ED%81%B4%EB%A1%9C%EC%A0%80)
  - 클로저에 대해서 아나요? 🔥🔥
  - 클로저를 사용하면 뭐가 좋죠? 🔥
  - 클로저를 어떻게 생성하나요? 🔥
- [클래스 🔥](about:blank#%ED%81%B4%EB%9E%98%EC%8A%A4)
  - 자바스크립트에서 클래스가 생기기 전에는 어떤 방식으로 객체지향 패턴을 구현했나요?
  - 그럼 생성자 함수와 클래스는 어떤 차이가 있나요?
  - 클래스 정의
  - 클래스의 상속
- [스프레드 문법 🔥](about:blank#%EC%8A%A4%ED%94%84%EB%A0%88%EB%93%9C-%EB%AC%B8%EB%B2%95)
  - spread 문법이 뭔가요?
  - 어떤 상황에서 사용할 수 있죠?
- [구조 분해 할당 🔥](about:blank#%EA%B5%AC%EC%A1%B0-%EB%B6%84%ED%95%B4-%ED%95%A0%EB%8B%B9)
  - 구조 분해 할당이 뭔가요?
  - 구조 분해 할당은 크게 어떤 종류가 있나요?
- [브라우저 렌더링 과정 🔥](about:blank#%EB%B8%8C%EB%9D%BC%EC%9A%B0%EC%A0%80-%EB%A0%8C%EB%8D%94%EB%A7%81-%EA%B3%BC%EC%A0%95)
...
- [DOM 🔥](about:blank#DOM)
  - DOM이 뭔가요?
  - DOM을 구성하는 건 뭐가 있나요?
- [이벤트 🔥](about:blank#%EC%9D%B4%EB%B2%A4%ED%8A%B8)
  ...
  - e.stopPropagation
- [타이머 🔥](about:blank#%ED%83%80%EC%9D%B4%EB%A8%B8)
  - 호출 스케쥴링이 무엇인가요?
  - 타이머 함수에는 어떤 것들이 있나요?
  - 이벤트가 과도하게 호출되어 성능에 문제를 일으킬 경우에 할 수 있는 어떤 일을 통해 해결할 수 있나요?
  - 디바운스에 대해서 알고 있나요?
  - 쓰로틀에 대해서 알고 있나요?
- [비동기 프로그래밍 🔥](about:blank#%EB%B9%84%EB%8F%99%EA%B8%B0-%ED%94%84%EB%A1%9C%EA%B7%B8%EB%9E%98%EB%B0%8D)
  - 동기와 비동기의 차이점에 대해서 설명해줄 수 있나요? 🔥
    - 한줄 요약
  - 이벤트 루프와 태스크 큐에 대해서 알고 있나요? 🔥🔥
  - 마이크로태스크 큐에 대해서 알고 있나요? 🔥
  - 태스크 큐와 마이크로태스크 큐 중 어떤 것이 먼저 실행되나요? 🔥
- [Ajax 🔥](about:blank#Ajax)
...
- [REST API 🔥](about:blank#REST-API)
  - REST API가 뭔가요?
  - REST API의 구성은 어떤 것이 있나요?
  - REST API를 설계하는데 중요한 것이 있을까요?
  - HTTP 요청 메서드에 대해서 아는대로 얘기해보세요
  - HTTP 상태 코드를 아는대로 말해주세요 🔥
- [Promise 🔥](about:blank#Promise)
  - 콜백이란 뭐라고 생각하나요? 🔥
  - 프로미스가 뭔가요? 🔥
  - 프로미스 생성 방법
  - 프로미스의 상태를 나타내는 것은 어떤 것들이 있나요? 🔥
  - 프로미스 빌트인 객체가 제공하는 정적 메서드에 대해 알고 있나요? 🔥
- [제너레이터와 async await 🔥](about:blank#%EC%A0%9C%EB%84%88%EB%A0%88%EC%9D%B4%ED%84%B0%EC%99%80-async-await)
  - 제너레이터란 뭔가요? 일반 함수와는 어떤 차이가 있죠?
  - 제너레이터의 구조
  - async/await 가 뭔가요? 기존의 Promise와는 어떤 차이가 있죠? 🔥
  - Promise와 async/await의 차이점 한 줄 요약 🔥
- [에러 🔥](about:blank#%EC%97%90%EB%9F%AC)
  - 에러처리를 왜 해야 하나요?
  - 자바스크립트에서 에러를 처리하는 방법에는 뭐가 있을까요?
- [모듈 🔥](about:blank#%EB%AA%A8%EB%93%88)
  - 모듈이 뭔가요?
...
- ② 함수 레벨 스코프
  ...
  // 함수 밖에서 var 키워드로 선언된 변수는 코드 블록 내에서 선언되었다 할지라도 모두 전역 변수다.  // 따라서 x는 전역 변수다. 이미 선언된 전역 변수 x가 있으므로 x 변수는 중복 선언된다.
...
![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/d6f622d3-dd1d-4654-adda-f05bad9076d5/Untitled.png)
...
![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/793a11eb-0105-4660-8c50-1b09c7d32d47/Untitled.png)
...
![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/a730beec-b34c-4ca6-a379-57579decced4/Untitled.png)
...
- 실행 컨텍스트 구조 한눈에 보기
  ![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/241a6795-8bff-4bae-b9ff-49a5cf0cd0b7/Untitled.png)
- 전역 실행 컨텍스트에 바인딩된 전역 렉시컬 환경
  ![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/e9830fec-17b0-434f-bd0a-d055e2b71ecb/Untitled.png)
- 함수 실행 컨텍스트에 바인딩된 함수 렉시컬 환경
  ![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/441b0d4d-2a94-4ffe-9e6f-1e8ccd895cbc/Untitled.png)
...
- 여러 케이스 보기
  ...
  ![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/1d8e973c-16f1-4e66-9acd-e7d8d0aeab24/Untitled.png)
  ...
  ![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/f897b7eb-0ca5-4dc6-b6be-396457f93b66/Untitled.png)
  ...
  ![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/582524a7-3db1-42cc-9b98-8c25bada233f/Untitled.png)
...
- **① 배열 구조분해 할당**
  ...
  */
  ...
  1. 반드시 프로퍼티 키와 변수 이름이 같을 필요는 없다
  ...
  */
  ...
  1. 객체 디스트럭처링 할당을 위한 변수에 기본값을 설정할 수 있다 (하지만 넘겨받는 값이 우선이다)
...
1. **서버에서 응답으로 받은 HTML 데이터를 파싱한다 (바이트 > 문자 > 토큰 > 노드 > DOM)**
...
- async/ defer
  ...
  ![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/5b42fa45-255c-4ad5-9163-eed17c85cccb/Untitled.png)
  ...
  ![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/860b2f67-d337-42d7-a163-8ea09c242c13/Untitled.png)
...
- **① 문서 노드**
  ...
  **③ 어트리뷰트 노드**
  ```html
  charset="UTF" rel="stylesheet" ... id="apple"
  ```
...
- 3단계 이미지 보기
  ![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/83ca2f12-0f1c-4edc-b054-93eab68f519f/Untitled.png)
...
![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/3ba94dd8-6874-44e1-978e-a4baa7e822d1/Untitled.png)
...
![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/2da70bca-7eef-470f-80f3-f60e7fb79fe1/Untitled.png)

```html
html.addEventListener("click", () => console.log("HTML"), true);
body.addEventListener("click", () => console.log("BODY"), true);
div.addEventListener("click", () => console.log("DIV")); >>> HTML BODY DIV
```
...
- ```html
  ...
  예를 들면, input창에 글씨를 입력하면 일정 시간동안 입력한 값을 한 번에 내보낸다. 검색 창에서 매 클릭 이벤트 (e.target.value) 마다 ajax 요청을 보내는 것보다 디바운스를 통해 일정 기간을 바탕으로 마지막 이벤트에 대한 ajax 요청을 보내는 것이 서버의 부하를 줄이는 데 더욱 효율적일 것이다.
...
- 자바스크립트 엔진은 기본적으로 함수를 호출하면 함수 코드가 평가되어 함수 실행 컨텍스트가 생성된다.
  ...
  ![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/11f3a37b-697c-47fa-88e5-f0443159922a/Untitled.png)
  ...
  ![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/1c832c08-b257-49d6-a9e3-3bc9f8cf0f01/Untitled.png)
  ...
  ![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/33c8cd1c-3878-43d3-a9f3-b8149a76703b/Untitled.png)
  **자바스크립트 엔진은 한 번에 하나의 태스크(작업, 일)만 실행할 수 있는 싱글 스레드 방식으로 동작한다.**
  ...
  ![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/69e70885-5083-4166-993e-1f25a147a576/Untitled.png)
  ...
  ![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/3ddb5b55-2111-4146-a193-79619a52ec57/Untitled.png)
...
![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/e651056e-4698-4d7b-b518-bd506040f8c5/Untitled.png)
...
- 구글의 v8 자바스크립트 엔진을 비롯한 대부분의 자바스크립트 엔진은 크게 2개의 영역으로 구분할 수 있다.
  **① 콜 스택 (call stack)**
  ...
  - F.I.F.O(First In First Out) 라고도 부른다
    ![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/635f2ff1-724e-46d8-8226-9ff2fb3e47b0/Untitled.png)
    **④ 이벤트 루프 (event loop)**
...
1. [Fetch](https://github.com/junh0328/upgrade_javascript/blob/master/DEEPDIVE/readme7.md#458-fetch)
...
- fetch 함수는 **XMLHttpRequest 객체와 마찬가지로 HTTP 요청 전송 기능을 제공하는 클라이언트 사이드 Web API다.**
  ...
  ![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/c70048a5-441b-42bc-a2ee-ca2e5f397166/Untitled.png)
...
![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/874557c7-d989-40af-8d30-52687ce39d8d/Untitled.png)
...
- 에러 캐치
  ...
  ```
  console.log("[Start]");foo(); // ReferenceError: foo is not definedconsole.log("[End]");
  ```
  ...
  ```
  console.log("[Start]");try {  foo();} catch (error) {  console.error("[에러 발생]", error);  // [에러 발생] ReferenceError: foo is not defined}// 발생한 에러에 적절한 대응을 하면 프로그램이 강제 종료되지 않는다.console.log("[End]");
  ```
...
![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/19e100ac-1a7d-4538-8ed8-6eab5000e2d2/Untitled.png)
